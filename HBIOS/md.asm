...
MD_INIT:
	...
	PRTS("ROMDISK=$")
;	LD	HL,ROMSIZE - 128
	LD	HL,$(BID_ROMDN - BID_ROMD0 + 1) * 32
	CALL	PRTDEC
	PRTS("KB RAMDISK=$")
;	LD	HL,RAMSIZE - 128
	LD	HL,$(BID_RAMDN - BID_RAMD0 + 1) * 32
	CALL	PRTDEC
	PRTS("KB$")
;
...
;#IF (PLATFORM == PLT_MT)
;MD_CAP0:
;	LD	HL,64 * (BID_ROMDN - BID_ROMD0 + 1)
;	JR	MD_CAP2
;MD_CAP1:
;	LD	HL,64 * (BID_RAMDN - BID_RAMD0 + 1)
;MD_CAP2:
;	XOR	A
;	LD	D,A			; NEVER EXCEEDS 64K, ZERO HIGH WORD
;	LD	E,A			; NEVER EXCEEDS 64K, ZERO HIGH WORD
;	RET
;#ELSE
MD_CAP0:
...
MD_WRITE:
	...
	LD	(MD_RWFNADR),BC		; SAVE IT AS PENDING IO FUNC
;
#IF (PLATFORM != PLT_MT)		; Allow writes to the ROM disk
	LD	A,(IY+MD_DEV)		; GET DEVICE NUMBER
