;
;==================================================================================================
;   RC2014 MT SBCPM STANDARD CONFIGURATION
;==================================================================================================
;
#include "cfg_mt.asm"
;
CPUOSC		.SET	8000000		; CPU OSC FREQ
...
;
IDEENABLE	.SET	FALSE		; TRUE FOR IDE DEVICE SUPPORT (CF MODULE)
...
SDMODE		.SET	SDMODE_MT	; SDMODE_MT
