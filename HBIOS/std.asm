...
SDMODE_MT	.EQU	8		; MT shift register for RC2014
;
...
#ENDIF
#IF (PLATFORM == PLT_MT)
  #DEFINE	PLATFORM_NAME	"RC2014 Z80 MT SBCPM"
#ENDIF
;
...
;BID_RAMDN	.EQU	BID_RAMN - 3	; LAST RAM DRIVE BANK
BID_RAMDN	.EQU	BID_RAMN - 2	; LAST RAM DRIVE BANK
;BID_AUX		.EQU	BID_RAMN - 2	; AUX BANK (BPBIOS, ETC.)
BID_AUX		.EQU	BID_BOOT	; not sure if this is safe
BID_BIOS	.EQU	BID_BOOT	; BIOS BANK is the BOOT BANK, not copied to RAM
